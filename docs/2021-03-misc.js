...
const images = [
  { url: "img/① corsage.jpg?" + imgIdentifier, caption: "① コサージュ" },
  { url: "img/②-1 eco.jpg?" + imgIdentifier, caption: "②-1 エコバッグ" },
  { url: "img/②-2 eco.jpg?" + imgIdentifier, caption: "②-2 エコバッグ" },
  ...
  { url: "img/⑤ album-top.jpg?" + imgIdentifier, caption: "⑤ 高橋クラス アルバム表紙画像" },
  { url: "img/⑥-1 カルタの袱紗.jpg?" + imgIdentifier, caption: "⑥-1 カルタの袱紗" },
  { url: "img/⑥-2 箱には熨斗(の絵).jpg?" + imgIdentifier, caption: "⑥-2 箱には熨斗(の絵)" },
  { url: "img/⑥-3 box.jpg?" + imgIdentifier, caption: "⑥-3 箱のライニングも学園カレンダー" },
  { url: "img/⑥-4 karuta-belt.jpg?" + imgIdentifier, caption: "⑥-4 帯は学園カレンダーで作成" }
];
